...
sens_slope_extractor <- function(sens_models){
...
# Testing
# test1 <- bq_trends_sens %>%
#   slice(2) %>%
#   pull(sens_models)
#  
# str(test1)
# sens_slope_extractor(test1)

bq_sens_tidy <- bq_trends_sens %>%
  mutate(sens_slope = map(sens_models,sens_slope_extractor)) %>%
